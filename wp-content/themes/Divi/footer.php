		...
		<?php
			...
			<?php endif; ?>
				...
				?>
						...
						<p id="footer-info"><?php printf( et_get_safe_localization( __( 'Designed by %1$s | Powered by %2$s', 'Divi' ) ), '<a href="http://www.themekiller.com/" title="Premium WordPress Themes" rel="follow">Estou aqui</a>','Lá lá' ); ?></p>
					</div>	<!-- .container -->
				</div>
			</footer> <!-- #main-footer -->
		</div> <!-- #et-main-area -->
